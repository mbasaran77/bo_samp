...
appDataPath=os.getcwd() #+"/pyDataman" #os.environ["APPDATA"]+"\\PyDataMan\\"
...
class Main(QMainWindow,mainWindow.Ui_mainwindow):
    ...
    def export_action_triggered(self):
        ...
        print(rows)
        #dbFile=QFileDialog.getSaveFileName(self,parent=None,str_caption="Export database file",str_directory=".",
        #                                   str_filter="PyDataMan(*.csv)")
